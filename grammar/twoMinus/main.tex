...
\begin{document}
    \begin{productions}
        ...
        \production{6.1}{subprogram\_declarations}{subprogram\_declarations
                                                   ...
                                                   \tm{;}}
        \production{6.2}{subprogram\_declarations}{subprogram\_declaration
                                                    \tm{;}}
        ...
        \production{7.3}{subprogram\_declaration}{subprogram\_head declarations \\
                                                compound\_statement}
        \production{7.4}{subprogram\_declaration}{subprogram\_head declarations}
        \production{8.1}{subprogram\_head}{\tm{procedure id ;}}
        ...
        \production{11.1}{compound\_statement}{\tm{begin} \\
                                             optional\_statements \\
                                             \tm{end}}
        \production{11.2}{compound\_statement}{\tm{begin} \\ \tm{end}}
        \production{12}{optional\_statements}{statement\_list}
