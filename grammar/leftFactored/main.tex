...
\begin{document}
    \begin{productions}
        ...
        \production{17.1}{array\_access}{\tm{id [} expression \tm{]}}
        ...
        \production{21.1}{expression}{simple\_expression}
        \production{21.2}{expression}{simple\_expression \tm{relop}
                                      simple\_expression}
        \production{23.1}{related\_expression}{\tm{relop} simple\_expression}
        \production{23.2}{related\_expression}{$\epsilon{}$}
        \production{23.1}{simple\_expression}{term simple\_expression$'$}
        \production{23.2}{simple\_expression}{sign term simple\_expression$'$}
        \production{23.3.1}{simple\_expression$'$}{\tm{addop} term
                                                   simple\_expression$'$}
        \production{23.3.2}{simple\_expression$'$}{$\epsilon{}$}
        ...
        \production{25.1}{factor}{variable}
        \production{25.2}{factor}{\tm{num}}
        \production{25.3}{factor}{\tm{(} expression \tm{)}}
        \production{25.4}{factor}{\tm{not} factor}
