...
\begin{document}
    \begin{productions}
        ...
        \production{25.1}{factor}{\tm{id}}
        \production{25.2}{factor}{\tm{id [} expression \tm{]}}
        \production{25.3}{factor}{\tm{num}}
        \production{25.4}{factor}{\tm{(} expression \tm{)}}
        \production{25.5}{factor}{\tm{not} factor}
